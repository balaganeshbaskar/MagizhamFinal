		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				<a class="navbar-brand" href="">
					<img src="images/brand-molc.jpg" class="d-inline-block align-top navbar_brand_logo" alt="Magizham">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown" >
					<ul class="nav navbar-nav" style="margin-left: auto;">
						...
						<li class="nav-item">
						<a class="nav-link active nav-link-external-style" href="curriculum/" style="color: #000000;">CURRICULUM</a>
						</li>
						<li class="nav-item">
						<a class="nav-link active nav-link-external-style" href="login.php" style="color: #000000;">
							<img src="images/log_in.png" width="40" height="40" class="d-inline-block align-top" alt="Magizham">
						</a>
						</li>
						<!-- <li class="nav-item">
							...
							<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12 about-us-content">
								<div class ="card-custom-about-us-new" style="text-align: center;">
									<div class="vision-statement-new">
										<p class="">Dhivya Bala , Mother of B Sai Krishan</p>
									</div>					
