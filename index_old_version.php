...
<html lang="en">
  ...
  <body>
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarNavDropdown" >
	      <ul class="nav navbar-nav navbar-center">
	        ...
	        <li class="nav-item">
	          <a class="nav-link active nav-link-external-style" href="forms/enrollment/" style="color: #b200e3;">ENROLL</a>
	        </li>
	      </ul>
	    </div>
	  </div>
					...
					<div class="about-us">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
								<div class="about-us-content" style="color: white; padding: 15px; position: relative; top: 50%;-ms-transform: translateY(-50%); transform: translateY(-50%);">
							...
							<div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
								<div style="position: relative; top: 50%;-ms-transform: translateY(-50%); transform: translateY(-50%);">		<img src="images/temp-image.jpg" class="contact-us-image">									
								</div>
							</div>							
						</div>
					</div>
	...
	<div class="container">
		<div class="about-us">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-12 col-md-6 col-xs-12">
					<div style="position: relative; top: 50%;-ms-transform: translateY(-50%); transform: translateY(-50%); margin-top: 20px; margin-bottom: 20px;">		<img src="images/temp-image.jpg" class="contact-us-image">			
					</div>					
				</div>
			</div>			
		</div>
	...
	<!-- special features of MOLC ends here -->
        ...
        <div class="swiper-slide">        	
						<div class="row">							
							<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12 about-us-content">
								<div class = "card-custom-about-us" style="text-align: center;">
									<div class="vision-statement">
										<p class="about-us-border">Dhivya Bala , Mother of B Sai Krishan</p>
									</div>					
        ...
        <div class="swiper-slide">        	
						<div class="row">							
							<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12 about-us-content">
								<div class = "card-custom-about-us" style="text-align: center;">
									<div class="vision-statement">
										<p class="about-us-border">Nowsafa Afrin, Mother of Hafsa Haseena & Hafisa Aimen </p>									</div>					
          ...
          <div class="row">
            ...
            <div class="col-xs-6 col-md-3">
              ...
              <ul class="footer-links">
                ...
                <li><a href="forms/enrollment/" data-aos="zoom-out">Enroll</a></li>
              </ul>
            </div>
          </div>
