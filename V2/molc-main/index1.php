			...
			<div class="container">
					<div class="about-us">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-lg-6 col-md-6">
								<div style="position: relative; top: 50%;-ms-transform: translateY(-50%); transform: translateY(-50%);">		<img src="images/molc-new-images/parallax-image-08.jpg" class="contact-us-image">									
								</div>
							</div>							
						</div>
					</div>
