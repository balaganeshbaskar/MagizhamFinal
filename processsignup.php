...
if (isset($_POST['btnsignup'])) 
{
  ...
  { 
    ...
    $teachercheck = $mysqli->query("INSERT INTO teachers (t_fname, t_sname, t_grade, t_subject, t_id) VALUES ('$t_fname', '$t_sname', '$t_grade', '$t_subject', '$t_id')");
...
else if (isset($_POST['new_update'])) 
{
  ...
  $teacherscheck = $mysqli->query("UPDATE teachers SET t_fname='$t_fname',t_sname='$t_sname',t_grade='$t_grade',t_subject='$t_subject',t_id='$t_id' where s_id='$s_id'") or die($mysqli->error());
